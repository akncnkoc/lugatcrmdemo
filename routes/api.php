...
Route::middleware(['auth:sanctum'])
  ->group(function () {
    ...
    Route::prefix('product-report')
      ->group(function () {
        Route::post('yearly-price-report', [
          \App\Http\Controllers\ProductReportController::class,
          'yearlyPriceReport'
        ])
    ...
    Route::prefix('product_log')
      ->group(function () {
        Route::post('table/{product_id?}', [
          \App\Http\Controllers\ProductLogController::class,
          'table'
        ])
    ...
    Route::prefix('incoming_waybill')
      ->group(function () {
        Route::post('get', [
          \App\Http\Controllers\IncomingWaybillController::class,
          'get'
        ])
    ...
    Route::prefix('outgoing_waybill')
      ->group(function () {
        Route::post('get', [
          \App\Http\Controllers\OutgoingWaybillController::class,
          'get'
        ])
    ...
    Route::prefix('customer_role')
      ->group(function () {
        Route::post('get', [
          \App\Http\Controllers\CustomerRoleController::class,
          'get'
        ])
    ...
    Route::prefix('staff_role')
      ->group(function () {
        Route::post('get', [
          \App\Http\Controllers\StaffRoleController::class,
          'get'
        ])
          ->name('staff_role.get');
        Route::post('all', [
    ...
    Route::prefix('safe')
      ->group(function () {
        Route::post('select', [
          \App\Http\Controllers\SafeController::class,
          'select'
        ])
          ->name('safe.select');
        Route::post('table', [
    ...
    Route::prefix('supplier-payment')
      ->group(function () {
        Route::post('get/{id?}', [
          \App\Http\Controllers\SupplierPaymentController::class,
          'get'
        ])
    ...
    Route::prefix('supplier-regular-payment')
      ->group(function () {
        Route::post('get', [
          \App\Http\Controllers\SupplierRegularPaymentController::class,
          'get'
        ])
...
//          ->name('incoming-waybill.delete');
    ...
    Route::prefix('staff-payment')
      ->group(function () {
        Route::post('get/{id?}', [
          \App\Http\Controllers\StaffPaymentController::class,
          'get'
        ])
    ...
    Route::prefix('staff-payment-type')
      ->group(function () {
        Route::post('get', [
          \App\Http\Controllers\StaffPaymentTypeController::class,
          'get'
        ])
