...
class ExpenseTest extends TestCase
{
  public function test_user_can_create_expense()
  {
    ...
    $this->post(route('expense.store'), $data)->assertStatus(200);
  }
  ...
  public function test_user_can_update_expense()
  {
    ...
    $this->post(route('expense.update'), $data)->assertStatus(200);
  }

  public function test_user_can_delete_expense()
  {
    $expense = Expense::factory()->create();
    $this->post(route('expense.delete'), ['id' => $expense->id])->assertStatus(200);
  }
  ...
  public function test_user_can_list_expense()
  {
    ...
    $this->post(route('expense.get'), ['id' => $expense->id])->assertStatus(200)->assertJsonStructure([
      'id',
      'price',
      'safe_id',
      'expense_type_id',
