<x-form.form id="filter_form">
  ...
  <div
    ...
    data-kt-menu="true" id="filter_menu">
    ...
    <div class="row row-cols-1">
      <x-form.select name="filter_currency" label="Para Birimi" :asyncload="route('currency.select')" placeholder="Para Birimi" multiple/>
    </div>
...
@push('customscripts')
  <script type="text/javascript">
    const SafeFilterTemplate = function () {
