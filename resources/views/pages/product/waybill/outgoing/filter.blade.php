...
<x-form.form id="filter_form">
  ...
  <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-1000px py-5 px-8" data-kt-menu="true">
    ...
    <div class="row row-cols-1">
      <x-form.select name="filter_customers" label="Müşteriler" placeholder="Müşteriler" multiple
                     :asyncload="route('customer.select')" parent="#filter_form"/>
    </div>
  ...
  <script type="text/javascript">
    ...
    $("button[data-filter-button]").click(function(e) {
      ...
      let min_product_val = min_product.val(),
        ...
        customers_val = filter_customers.val();
      initOutgoingWaybillTable({
