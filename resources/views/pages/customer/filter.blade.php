<x-form.form id="filter_form">
  ...
  <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-700px py-5 px-8" data-kt-menu="true">
    ...
    <div class="row row-cols-2">
      <x-form.select name="filter_customer_role_id" label="Rol" placeholder="Rol" :asyncload="route('customer_role.select')" required />
      <div class="d-flex align-items-center">
        <x-form.radio label="Cinsiyet" checked="-1" name="filter_gender" hint="Eğer müşteri bir firma yada tüzel kişiyşe diğeri seçin" :items="['Hepsi' => '-1', 'Erkek' => 1, 'Kadın' => 2, 'Diğer' => 3]" />
      </div>
    </div>
